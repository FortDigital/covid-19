...
INFLUX_USER = ''
INFUX_PASS = ''
INFLUX_DROPMEASUREMENT = False #False on delta as we are just adding extra data
client = InfluxDBClient(INFLUX_HOST, INFLUX_DBPORT,INFLUX_USER,INFUX_PASS, INFLUX_DB)
GMT = Zone(0, False, 'GMT')
#Direct Link to file
#Lookbackdays can be 30/14/7/latest and represents the number of days worth of data to pull back for the delta, Starting with 7 days to give some overlap
Lookbackdays = "7"
...
epidemiologyfile = "https://open-covid-19.github.io/data/v2/"+Lookbackdays+"/epidemiology.csv" #Has Date
...
hospitalizationsfile = "https://open-covid-19.github.io/data/v2/"+Lookbackdays+"/hospitalizations.csv" #Has Date - All Fields (Apart from Date and key)
mobilityfile = "https://open-covid-19.github.io/data/v2/mobility.csv"#All Tags
oxfordfile = "https://open-covid-19.github.io/data/v2/"+Lookbackdays+"/oxford-government-response.csv" #Has Date - All Fields (Apart from Date and key)
weatherfile = "https://open-covid-19.github.io/data/v2/"+Lookbackdays+"/weather.csv" #Has Date - all fields (Apart from Date and key)
agefile = "https://open-covid-19.github.io/data/v2/"+Lookbackdays+"/by-age.csv" #Has Date - Quiet complicated, some Columns include bucket definitions - Skip for now
sexfile = "https://open-covid-19.github.io/data/v2/"+Lookbackdays+"/by-sex.csv" #Has Date - all fields (Apart from Date and key)
KeyHash = {}
measurements = []
measurements_hash = {}
measurecount = 0
